...
namespace TruVineItemHandler
{
    ...
    public class TruVineItemHandler
    {
        ...
        public TruVineItemHandler() {
            ...
            var parametersRegexPattern = $"^/items/(?<{partitionKeyName}>[^/]+)";
            if (hasSortKey) {
